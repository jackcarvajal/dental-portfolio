            ...
            if (tipo === 'nequi') {
                ...
                content = `
                    ...
                    <div class="pay-box" style="--pay-accent:#9B5DE5;">
                        ...
                        <button type="button" class="pay-copy" onclick="navigator.clipboard.writeText('3228774481');this.textContent='✅ Copiado';setTimeout(()=>this.textContent='📋 Copiar número',1500);">📋 Copiar número</button>
                ...
                content = `
                    ...
                    <div class="pay-box" style="--pay-accent:#8A05BE;">
                        ...
                        <button type="button" class="pay-copy" onclick="navigator.clipboard.writeText('LXY423');this.textContent='✅ Copiado';setTimeout(()=>this.textContent='📋 Copiar llave',1500);">📋 Copiar llave</button>
                    ...
                    <div class="pay-box" style="--pay-accent:var(--gold-primary);">
                        ...
                        <h3>Jessica</h3>
                        <div class="pay-num">322 877 4481</div>
                        <button type="button" class="pay-copy" onclick="navigator.clipboard.writeText('3228774481');this.textContent='✅ Copiado';setTimeout(()=>this.textContent='📋 Copiar',1500);">📋 Copiar</button>
                    </div>
            ...
            try {
                ...
                if (_sb) {
                    ...
                    _sb.from('pedidos').insert([{
                        ...
                        email:            _email,
                        negocio:          'prodigy',
                        nombre_doctor:    STATE.nombreCliente,
                        telefono:         STATE.whatsappCliente,
                        tipo_trabajo:     CONFIG.materiales[STATE.materialTipo]?.nom || STATE.materialTipo,
                        ...
                        stl_url:          STATE.linkSTL,
                        hash_seguridad:   _nonce,
                        flujo:            'impresion',
            ...
            modal.innerHTML = `
                <div style="background:#ffffff;border:2px solid #E87427;border-radius:12px;width:90%;max-width:700px;box-shadow:0 0 40px rgba(232,116,39,0.4);">
                    ...
                    <div style="padding:0 20px 20px;">
                        <button type="button" onclick="document.getElementById('help-modal').remove()" style="width:100%;padding:12px;background:#E87427;border:none;border-radius:8px;color:#fff;font-size:0.95rem;font-weight:800;cursor:pointer;transition:all 0.3s;">
                            Aceptar
                        </button>
                    </div>
                </div>
